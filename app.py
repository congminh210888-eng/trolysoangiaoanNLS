...
<div class="main-header">
    ...
    <p>Tác giả: MA Công Minh - Trường PTDTBT Tiểu học Bản Ngò - ĐT: 097 1986 343</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Công Minh - Trường PTDTBT Tiểu học Bản Ngò - ĐT: 097 1986 343</div>", unsafe_allow_html=True)
