...
<div class="main-header">
    ...
    <p>Tác giả: MA Công Minh - Trường tiểu học Minh Quang - ĐT: 0977 593 090</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Công Minh - Trường Tiểu Học Minh Quang - ĐT: 0977 593 090</div>", unsafe_allow_html=True)
